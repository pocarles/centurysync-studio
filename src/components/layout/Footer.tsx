        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <span className="text-xl font-bold tracking-tight text-cream">
              ...
              <span>Sync</span>
              <span className="ml-1 font-medium text-sm text-cream/50">
                Studio
              </span>
            </span>
            <p className="mt-3 text-sm leading-relaxed text-cream/60 max-w-xs">
              AI systems that augment your business. Built with intention, not
              hype.
            </p>
          </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider text-cream/40 mb-3">
              Contact
            </h3>
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-cream/50">{CONTACT.address}</li>
            </ul>
          </div>
